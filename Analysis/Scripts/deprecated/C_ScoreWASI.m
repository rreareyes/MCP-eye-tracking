...
cd('..')
folder.Root    = pwd;
folder.Data    = fullfile(folder.Root, 'Demographics_Scales', 'WASI'); %location of the mat files
folder.Results = fullfile(folder.Root, 'Demographics_Scales'); %where we are saving the output
